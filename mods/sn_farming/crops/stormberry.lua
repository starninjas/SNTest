...
-- stormberry
minetest.register_craftitem("farming:stormberry", {
	description = S("stormberry"),
	inventory_image = "farming_stormberry.png",
	groups = {food_stormberry = 1, food_blueberry = 1, food_berry = 1, flammable = 2},
...
minetest.register_craft({
	...
	recipe = {
		{"group:food_stormberry", "group:food_bread", "group:food_stormberry"},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		"group:food_stormberry", "group:food_baking_tray"
	},
...
crop_def.drop = {
	items = {
		{items = {'farming:stormberry 2'}, rarity = 1},
		{items = {'farming:stormberry'}, rarity = 2},
		{items = {'farming:stormberry'}, rarity = 3},
	}
}
minetest.register_node("farming:blueberry_4", table.copy(crop_def))

-- add to registered_plants
farming.registered_plants["farming:stormberry"] = {
	crop = "farming:blueberry",
	seed = "farming:stormberry",
	minlight = 13,
	maxlight = 15,
	steps = 4
}
